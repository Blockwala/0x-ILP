...
var result = JSON.parse(fs.readFileSync(file + "UserTokenSale.json"));
var userTokenSaleAbi = result.abi;

var userTokenSale;
var userTokenSaleAddress = config.get('token_sale_address');

var userTokenSaleSocket;
